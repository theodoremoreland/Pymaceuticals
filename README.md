...
Data analytics using Python, Pandas, and Matplotlib. The data features 250 mice that were treated through a variety of drug regimes over the course of 45 days. Their physiological responses were then monitored over the course of that time. This project aims to compare the affects of various treatments. The end results feature the following:
